(() => {
    ...
    class Popup {
        constructor(options) {
            let config = {
                ...
                classes: {
                    popup: "cart",
                    popupWrapper: "cart__wrapper",
                    popupContent: "cart__content",
                    popupActive: "cart_show",
                    bodyActive: "cart-show"
                },
                focusCatch: true,
                closeEsc: true,
                bodyLock: true,
        ...
        eventsPopup() {
            document.addEventListener("click", function(e) {
                ...
                if (buttonClose || !e.target.closest(`.${this.options.classes.popupWrapper}`) && this.isOpen) {
                    e.preventDefault();
                    this.close();
                    return;
                }
    ...
    function formSubmit() {
        ...
        function formSent(form, responseResult = ``) {
            ...
            setTimeout((() => {
                alert("We will keep you updated with all our news!");
            }), 500);
        }
    ...
    da.init();
    const container = document.querySelector(".partners__ticker");
    const itemsInner = document.querySelector(".partners__ticker-inner");
    const clone = itemsInner.cloneNode(true);
    container.appendChild(clone);
    let scrollPosition = 0;
    const scrollSpeed = 1;
    function scrollLogos() {
        scrollPosition -= scrollSpeed;
        if (scrollPosition <= -itemsInner.scrollWidth) scrollPosition = 0;
